...
// ── Demo Events (4) ────────────────────────────────────────
// Shapes match the calendarEventsPublic projection so the
// EventResultCard and event filtering work unchanged.
// Dates are relative to "now" so the date filter is always testable.
...
export const DEV_DEMO_EVENTS = [
  {
    event_id: 'demo-evt-1',
    title: 'Sunrise Yoga Flow',
    description: 'Start your day with an energising vinyasa flow. All levels welcome — bring your own mat.',
    start_time: daysFromNow(1, 7, 0),
    end_time: hoursLater(daysFromNow(1, 7, 0), 1),
    timezone: 'Europe/London',
    all_day: false,
    location_type: 'physical',
    location_label: 'Zenith Yoga Studio, Manchester',
    location_geo: { latitude: 53.4808, longitude: -2.2426 },
    services: [svc('yoga'), svc('meditation')],
    cover_url: cover('yoga-event'),
    price_pence: 0,
    currency: 'GBP',
    is_free: true,
    capacity: 20,
    ...
    owner_id: 'demo-pro-2',
    business_id: null,
    _updated_date: new Date('2026-08-25').toISOString(),
  },
  {
    event_id: 'demo-evt-2',
    title: 'Strength & Conditioning Workshop',
    description: 'A 2-hour intensive workshop covering compound lifts, accessory work, and programming fundamentals.',
    start_time: daysFromNow(3, 18, 0),
    end_time: hoursLater(daysFromNow(3, 18, 0), 2),
    timezone: 'Europe/London',
    all_day: false,
    location_type: 'physical',
    location_label: 'Iron Works Gym, London',
    location_geo: { latitude: 51.5074, longitude: -0.1278 },
    services: [svc('strength-conditioning'), svc('personal-training')],
    cover_url: cover('strength-event'),
    price_pence: 2500,
    currency: 'GBP',
    is_free: false,
    capacity: 12,
    ...
    owner_id: 'demo-pro-1',
    business_id: null,
    _updated_date: new Date('2026-08-26').toISOString(),
  },
  {
    event_id: 'demo-evt-3',
    title: 'Online Nutrition Masterclass',
    description: 'Live online session covering sustainable nutrition strategies for busy professionals. Recording included.',
    start_time: daysFromNow(5, 19, 0),
    end_time: hoursLater(daysFromNow(5, 19, 0), 1.5),
    timezone: 'Europe/London',
    all_day: false,
    ...
    location_geo: null,
    services: [svc('nutrition-coaching'), svc('meal-planning')],
    cover_url: cover('nutrition-event'),
    price_pence: 1500,
    currency: 'GBP',
    is_free: false,
    capacity: 50,
    ...
    owner_id: 'demo-pro-5',
    business_id: null,
    _updated_date: new Date('2026-08-27').toISOString(),
  },
  {
    event_id: 'demo-evt-4',
    title: 'Boxing Fundamentals Open Session',
    description: 'A community boxing session for all levels. Gloves provided. No experience needed.',
    start_time: daysFromNow(7, 11, 0),
    end_time: hoursLater(daysFromNow(7, 11, 0), 1.5),
    timezone: 'Europe/London',
    all_day: false,
    location_type: 'hybrid',
    location_label: 'Eastside Boxing Club, London / Online',
    location_geo: { latitude: 51.5099, longitude: -0.0057 },
    services: [svc('boxing'), svc('group-fitness')],
    cover_url: cover('boxing-event'),
    price_pence: 0,
    currency: 'GBP',
    is_free: true,
    capacity: 30,
    ...
    host: {
      type: 'business',
      id: 'demo-biz-4',
      display_name: 'Eastside Boxing Club',
      screen_name: null,
      business_id: 'demo-biz-4',
      avatar_url: null,
      verification_state: 'not_verified',
    ...
    owner_id: 'demo-biz-4',
    business_id: 'demo-biz-4',
    _updated_date: new Date('2026-08-28').toISOString(),
  },
];