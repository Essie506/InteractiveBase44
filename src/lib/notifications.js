...
const DELIVERY_POLICY = {
  ...
  booking_invitation:        { in_app: 'required',     email: 'required',    push: 'conditional', sms: 'prohibited' },
  booking_confirmed:          { in_app: 'required',     email: 'required',    push: 'conditional', sms: 'prohibited' },
  booking_cancelled:          { in_app: 'required',     email: 'conditional', push: 'conditional', sms: 'prohibited' },
  booking_rescheduled:        { in_app: 'required',     email: 'conditional', push: 'conditional', sms: 'prohibited' },
  booking_completed:          { in_app: 'required',     email: 'conditional', push: 'conditional', sms: 'prohibited' },
  booking_no_show:            { in_app: 'required',     email: 'conditional', push: 'conditional', sms: 'prohibited' },
