    ...
    <div className="relative">
      ...
      {open && (
        <>
          ...
          <div className="absolute top-full mt-1 left-1/2 -translate-x-1/2 z-20 w-80 max-w-[calc(100vw-1rem)] bg-white rounded-xl border border-stone-200 shadow-xl overflow-hidden">
