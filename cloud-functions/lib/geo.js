...
exports.deriveProfessionalPublicGeo = deriveProfessionalPublicGeo;
exports.fetchProfessionalPublicGeo = fetchProfessionalPublicGeo;
exports.deriveBusinessPublicGeo = deriveBusinessPublicGeo;
exports.fetchBusinessPublicGeo = fetchBusinessPublicGeo;
// ── Professional ──────────────────────────────────────────────
// Never exposes exact coordinates. Only 'approximate' + 'public'.
function deriveProfessionalPublicGeo(locationData) {
    if (!locationData)
        return null;
    if (locationData.visibility !== 'public')
        return null;
    if (locationData.precision_level !== 'approximate')
        return null;
...
async function fetchProfessionalPublicGeo(db, serviceAreaLocationId, locationId) {
...
function deriveBusinessPublicGeo(locationData) {
    if (!locationData)
        return null;
    if (locationData.visibility !== 'public')
        return null;
...
async function fetchBusinessPublicGeo(db, locationId) {
    if (!locationId)
        return null;
    try {
